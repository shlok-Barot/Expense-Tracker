...
const Cards = (props) => {
  ...
  if (expenses && authUser) {
    ...
    const thisUsersExpensesThisMonth = utils.currentMonthExpenses(
      eachExpense,
      authUser
    );
    ...
    const thisUsersExpensesThisWeek = utils.expensesThisWeek(
      eachExpense,
      authUser
    );
    const thisUsersExpensesThisYear = utils.expensesinCurrentYear(
      eachExpense,
      authUser
    );
          ...
          <div className="col-sm-6 col-md-4 col-lg-3">
            <div className="card card6" style={cards.card6}>
              <div className="card-block">
                ...
                <p style={cardStyleDesktop} className="card-text">
                  &nbsp;
                  {settings.editedCategories[mostSpentCategory]
                    ? settings.editedCategories[mostSpentCategory]
                    : mostSpentCategory}
                </p>
              </div>
          ...
          <div className="slider">
            ...
            <div className="slides">
              ...
              <div id="slide-2">
                <div className="col-sm-6 col-md-4 col-lg-3 nopadding mobileNoPadding">
                  <div
                    className="card card5 mobileNoPadding"
                    style={cards.card5}
                  >
                    <div className="card-block">
                      <h3 style={cardStyleMobile} className="card-title">
              ...
              <div id="slide-5">
                <div className="col-sm-6 col-md-4 col-lg-3 nopadding mobileNoPadding">
                  <div
                    className="card card3 mobileNoPadding"
                    style={cards.card3}
                  >
                    <div className="card-block">
                      <h3 style={cardStyleMobile} className="card-title">
              ...
              <div id="slide-6">
                <div className="col-sm-6 col-md-4 col-lg-3 nopadding mobileNoPadding">
                  <div
                    className="card card6 mobileNoPadding"
                    style={cards.card6}
                  >
                    <div className="card-block">
                      <h3 style={cardStyleMobile} className="card-title">
              ...
              <div id="slide-7">
                <div className="col-sm-6 col-md-4 col-lg-3 nopadding mobileNoPadding">
                  <div
                    className="card card7 mobileNoPadding"
                    style={cards.card7}
                  >
                    <div className="card-block">
                      <h3 style={cardStyleMobile} className="card-title">
              ...
              <div id="slide-8">
                <div className="col-sm-6 col-md-4 col-lg-3 nopadding mobileNoPadding">
                  <div
                    className="card card8 mobileNoPadding"
                    style={cards.card8}
                  >
                    <div className="card-block">
                      <h3 style={cardStyleMobile} className="card-title">
